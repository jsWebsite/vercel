...
Defined in: [packages/oidc/src/get-vercel-oidc-token-sync.ts:25](https://github.com/jsWebsite/vercel/blob/main/packages/oidc/src/get-vercel-oidc-token-sync.ts#L25)
